...
export const grades: Grade[] = [
  ...
  },
  {
    ...
    subjects: [
      ...
      {
        id: "makedonski-jazik-3",
        label: "Македонски Јазик",
        icon: BookOpen,
        color: "14 80% 45%",
        categories: [
          {
            id: "recenici-makedonski-3",
            label: "Реченици",
            description: "Структура и типови реченици",
            file: `${import.meta.env.BASE_URL}data/3-recenici.json`,
            icon: BookOpen,
            color: "14 80% 45%",
          },
          {
            id: "imenki-makedonski-3",
            label: "Именки",
            description: "Видови и класификација на именки",
            file: `${import.meta.env.BASE_URL}data/3-imenki.json`,
            icon: Compass,
            color: "14 80% 45%",
          },
          {
            id: "direkten-indirektен-govor-3",
            label: "Директен и индиректен говор",
            description: "Преведување и употреба на директен и индиректен говор",
            file: `${import.meta.env.BASE_URL}data/3-direkten_indirektеn_govor.json`,
            icon: BookOpen,
            color: "14 80% 45%",
          },
          {
            id: "pridavki-makedonski-3",
            label: "Придавки",
            description: "Видови и степенување на придавки",
            file: `${import.meta.env.BASE_URL}data/3-pridavki.json`,
            icon: BookOpen,
            color: "14 80% 45%",
          },
          {
            id: "glagoli-makedonski-3",
            label: "Глаголи",
            description: "Видови, времиња и облици на глаголи",
            file: `${import.meta.env.BASE_URL}data/3-glagoli.json`,
            icon: BookOpen,
            color: "14 80% 45%",
          },
        ],
  ...
  grade1: [
    {
      id: "matematika-1",
      label: "Математика",
      url: `${import.meta.env.BASE_URL}ucebnici/matematika_1.pdf`,
      color: "340 65% 50%",
    },
        {
      id: "makedonski-1",
      label: "Македонски Јазик",
      url: `${import.meta.env.BASE_URL}ucebnici/makedonski_1.pdf`,
      color: "14 80% 45%",
    },
    {
      id: "prirodni-1",
      label: "Природни Науки",
      url: `${import.meta.env.BASE_URL}ucebnici/prirodni_1.pdf`,
      color: "120 65% 45%",
    },
    {
      id: "opstestvo-1",
      label: "Општество",
      url: `${import.meta.env.BASE_URL}ucebnici/opstestvo_1.pdf`,
      color: "220 65% 55%",
    },
  ],
  grade2: [
    {
      id: "matematika-2",
      label: "Математика",
      url: `${import.meta.env.BASE_URL}ucebnici/matematika_2.pdf`,
      color: "340 65% 50%",
    },
        {
      id: "makedonski-2",
      label: "Македонски Јазик",
      url: `${import.meta.env.BASE_URL}ucebnici/makedonski_2.pdf`,
      color: "14 80% 45%",
    },
    {
      id: "prirodni-2",
      label: "Природни Науки",
      url: `${import.meta.env.BASE_URL}ucebnici/prirodni_2.pdf`,
      color: "259 78% 51%",
    },
    {
      id: "opstestvo-2",
      label: "Општество ",
      url: `${import.meta.env.BASE_URL}ucebnici/opstestvo_2.pdf`,
      color: "220 65% 55%",
    },
  ],
  grade3: [
